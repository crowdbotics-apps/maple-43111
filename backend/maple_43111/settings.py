"""
Django settings for maple_43111 project.
...
WSGI_APPLICATION = 'maple_43111.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "maple_43111 API",
    "DESCRIPTION": "API documentation for maple_43111 App",
    "VERSION": "v1",
}
